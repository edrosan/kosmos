...
var relativePath = (base = "", path) => !path.toLowerCase().indexOf(base.toLowerCase()) ? path.slice(base.length) || "/" : "~" + path;
...
var ParamsCtx = (0, import_react.createContext)({});
...
var Link = (0, import_react.forwardRef)((props, ref) => {
  const router = useRouter();
  const [path, navigate2] = useLocationFromRouter(router);
  const {
    to,
    href: _href = to,
    onClick: _onClick,
  ...
  return asChild && (0, import_react.isValidElement)(children) ? (0, import_react.cloneElement)(children, { onClick, href }) : (0, import_react.createElement)("a", {
    ...
    className: (cls == null ? void 0 : cls.call) ? cls(path === href) : cls,
    children,
    ref
  });
});
